...
from .datasets import CIFAR10,CIFAR100,ImageFolder,FashionMNIST,MNIST

irange = range

# 数据集存储位置
datasRoot = "./dlib/datas/"
root = './taskscenter/tlapp/'
# 通用数据集存储根路径
commonRoot = root + "dlib/datas/commons/"
# 用户数据集存储根路径 User DataRoot
userDRoot = root + "dlib/datas/{}/{}"
userDSpace = root + 'dlib/datas/{}/'
# 数据操作映射
transMap ={
    "ToTensor":T.ToTensor, 
...
# 系统Common通用公开数据集
CommonDataSetCollections = ["CIFAR10","MNIST","FashionMNIST"]
# 数据集映射
datasetMap = {
        "CIFAR10":CIFAR10,
        "MNIST":MNIST,
